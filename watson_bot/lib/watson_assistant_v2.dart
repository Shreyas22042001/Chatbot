...
class WatsonAssistantResponse {
  ...
  WatsonAssistantResponse({required this.resultText, required this.context});
}
  ...
  Future<WatsonAssistantResponse?> sendMessage(
    ...
    try {
      ...
      var newSess = await http.post(
          Uri.parse('${watsonAssistantCredential.url}/assistants/${watsonAssistantCredential.assistantID}/sessions?version=${watsonAssistantCredential.version}'),
      ...
      var receivedText = await http.post(
        Uri.parse('${watsonAssistantCredential.url}/assistants/${watsonAssistantCredential.assistantID}/sessions/$session_id/message?version=${watsonAssistantCredential.version}'),
        headers: {'Content-Type': 'application/json', 'Authorization': authn},
        body: json.encode(_body),
        //body: data
      );
